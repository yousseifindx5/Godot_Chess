...
const BLACK_BISHOP = preload("res://Assets/Sprites/black_bishop.png")
const BLACK_KING = preload("res://Assets/Sprites/black_king.png")
const BLACK_KNIGHT = preload("res://Assets/Sprites/black_knight.png")
const BLACK_PAWN = preload("res://Assets/Sprites/black_pawn.png")
const BLACK_QUEEN = preload("res://Assets/Sprites/black_queen.png")
const BLACK_ROOK = preload("res://Assets/Sprites/black_rook.png")
const WHITE_BISHOP = preload("res://Assets/Sprites/white_bishop.png")
const WHITE_KING = preload("res://Assets/Sprites/white_king.png")
const WHITE_KNIGHT = preload("res://Assets/Sprites/white_knight.png")
const WHITE_PAWN = preload("res://Assets/Sprites/white_pawn.png")
const WHITE_QUEEN = preload("res://Assets/Sprites/white_queen.png")
const WHITE_ROOK = preload("res://Assets/Sprites/white_rook.png")

const TURN_WHITE = preload("res://Assets/Sprites/turn-white.png")
const TURN_BLACK = preload("res://Assets/Sprites/turn-black.png")
...
func set_move(var2, var1):
	...
	if (selected_piece.x != var2 || selected_piece.y != var1) && (white && board[var2][var1] > 0 || !white && board[var2][var1] < 0):
		...
		if white && is_in_check(white_king_pos): get_tree().change_scene_to_file("res://Scenes/Black wins.tscn")
		elif !white && is_in_check(black_king_pos):get_tree().change_scene_to_file("res://Scenes/White wins.tscn")
		else: print("Draw")
